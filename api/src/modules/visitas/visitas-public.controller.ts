...
export class VisitasPublicController {
  ...
  @Get(':token')
  @ApiOperation({ summary: 'Obtener información de la visita por token seguro' })
  ...
  @ApiOperation({ summary: 'Confirmar, reprogramar o cancelar visita (acción del cliente)' })
  procesarAccion(@Param('token') token: string, @Body() dto: AccionReprogramarDto) {
