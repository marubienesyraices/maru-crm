...
export class PortalController {
  ...
  @Get('branding')
  @ApiOperation({
    summary: 'Colores y nombre del tenant del portal (empresa por defecto)',
  })
  getBranding() {
  ...
  @ApiOperation({
    summary:
      'Registrar interés de cliente en una propiedad (inicia verificación de email)',
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Verificar email de cliente con token de activación',
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Registrar lead capturado por el chatbot del portal',
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Solicitar enlace mágico de acceso al panel del cliente',
  })
  ...
  @ApiOperation({
    summary:
      'Iniciar sesión con Google OAuth — crea o recupera cuenta de cliente',
  })
  googleAuth(
