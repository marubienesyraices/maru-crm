          ...
          {isSuperAdmin ? (
            <>
              ...
              {[
                ...
                { to: '/admin/sistema',  label: 'Config. Sistema', icon: <><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14M12 2v2M12 20v2M2 12h2M20 12h2"/></> },
              ].map(({ to, label, icon }) => (
            ...
            <>
              {[
                ...
                ...(!pf || pf.tiene_ranking ? [{ to: '/ranking', label: 'Ranking', icon: <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/> }] : []),
                { to: '/tareas',      label: 'Mis Tareas',      icon: <><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></> },
                { to: '/horarios',    label: 'Mi Horario',      icon: <><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></> },
              ...
              {isAdmin && (
                <>
                  <div className="nav-section-label">{!collapsed && 'Administración'}</div>
                  {[
                    { to: '/settings/empresa', label: 'Mi Empresa', show: true, icon: <><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></> },
                    ...
                    { to: '/admin/organigrama',      label: 'Organigrama',    show: !pf || pf.tiene_organigrama, icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></> },
                    ...
                    { to: '/settings/documentos',    label: 'Documentos PDF', show: true, icon: <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></> },
